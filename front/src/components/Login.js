  ...
  return (
    <Modal show={show} onHide={handleClose} centered>
      ...
      <Modal.Body>
        ...
        <Form onSubmit={isCreatingUser ? handleCreateUser : handleLogin} className="login-form">
        ...
        <div className="text-center mt-3">
          {isCreatingUser ? (
            <Button variant="link" onClick={() => handleCreationSwitch(false)} className="login-switch-btn">
              Already have an account? Login
            </Button>
          ) : (
            <Button variant="link" onClick={() => handleCreationSwitch(true)} className="login-switch-btn">
